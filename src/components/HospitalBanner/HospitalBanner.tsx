...
const HospitalBanner: FC<HospitalBannerProps> = ({ name, description, metrics }) => {
    ...
    return (
        <div className={`relative transition-all duration-300 w-full px-3 sm:px-4 lg:px-6 ${
            isExpanded 
            ...
            <div className="relative h-full max-w-7xl mx-auto flex flex-col justify-center py-3 sm:py-4 lg:py-6 px-6 sm:px-8 lg:px-10">
                ...
                <div className="max-w-3xl">
                    <p className={`text-white/90 text-xs sm:text-sm lg:text-base mb-1 sm:mb-2 relative ${
