                    ...
                    <div key={hospital.id} className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
                        ...
                        <div className="mt-4 flex items-center gap-1.5">
                            {hospital.specialties.slice(0, 3).map((specialty, index) => (
                                <span key={index} className="px-2 py-0.5 bg-gray-50 rounded-full text-xs text-gray-600 whitespace-nowrap">
                                    {specialty}
                                </span>
                            ))}
                            {hospital.specialties.length > 3 && (
                                <span className="px-2 py-0.5 bg-gray-50 rounded-full text-xs text-blue-600 whitespace-nowrap">
