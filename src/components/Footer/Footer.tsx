...
const Footer: FC = () => {
    return (
        <footer className="w-full bg-gray-50 py-12 pb-0 relative">
            <div className="absolute inset-0 bg-gray-50 -left-[100vw] -right-[100vw]"></div>
            <div className="px-6 relative max-w-[1366px] mx-auto">
